    ...
    planos: {
      ...
      elite: {
        ...
        items: [
          ...
          { text: "Un painel com produtos mis à jour", status: true },
          { text: "Acesso à origem de Eletrônicos, Gamer, Periféricos, Acessórios para Celular, Automotivo, Vêtements, Baskets, Montres, Perfumes, Sacs, Joias, Lunettes, Beleza, Maquiagem, Sex Shop, Fitness, Esporte, Ciclismo, Pesca, Casa e Cozinha, Decoração, Iluminação, Jardinagem, Ferramentas, Jouets, Papelaria, Pet, Festa e Brindes.", status: true },
          { text: "Gerador de imagens 4K (10 créditos mensais).", status: true },
          { text: "Inteligência Artificial o Minerador de buscas e perguntas.", status: true },
          { text: "Accès àos marketplaces locais na China.", status: true },
                ...
                >
                  ...
                  {plan.id !== 'free' && (
                    <div className="mt-5 flex flex-col items-center gap-2.5 w-full">
                      ...
                      {!isBrasil && (
                        <div className="flex items-center justify-center gap-3.5 mt-0.5 opacity-90">
                          {/* Mastercard */}
                          ...
                          <div className="flex items-center justify-center">
                            <svg viewBox="0 0 200 65" className="h-[10px] w-auto">
                              <path fill="#ffffff" d="M84.14,0.18L59.1,64.35H20.65L1.08,8.2C0.1,5.32,-0.47,4.32,1.35,2.77C3.12,1.26,9.15,0.21,11.83,0l17.75,0.18l11.45,41.42C44.73,55.51,46.12,60.6,46.12,60.6L68.74,0.18H84.14zM109.11,0.18h-19l-9.98,64.17h19.23L109.11,0.18zM151.78,41.97c0,-23.77,-33.14,-25,-33.14,-35.5c0,-3.23,3.3,-6.69,11.1,-7.69c3.9,-0.5,14.63,-0.89,23.36,3.22l4.16,-19.16C148.6,0.35,138.83,-2,127.28,-2c-19.82,0,-33.78,10.51,-33.91,25.64c-0.12,11.16,9.93,17.41,17.52,21.14c7.81,3.83,10.42,6.31,10.42,9.75c0,5.27,-6.29,7.69,-12.18,7.69c-10.2,0,-15.7,-1.56,-24.12,-5.3l-4.25,19.85c8.43,3.9,20.08,7.24,32.32,7.39C134.46,64.17,151.78,54.26,151.78,41.97zM196.11,0.18h-14.8c-4.47,0,-7.8,1.26,-9.76,5.88l-27.78,58.29h20.21l4.03,-11.2h24.68l2.36,11.2h17.8L196.11,0.18zM173.18,37.26l6.32,-17.16c0,0,1.06,-3.02,1.72,-5.07c0.3,1.6,0.85,4.3,0.85,4.3l3.6,17.93H173.18z" />
                            </svg>
                          </div>
                          {/* G Pay */}
                          <div className="flex items-center justify-center gap-[3px]">
                            ...
                            <span className="text-[13px] font-[500] text-white tracking-widest leading-none mt-0.5" style={{ fontFamily: 'sans-serif' }}>Pay</span>
                          </div>
                          {/* Apple Pay */}
                          <div className="flex items-center justify-center gap-[2px]">
                            <svg className="h-[13px] w-auto fill-white mb-[1px]" viewBox="0 0 384 512">
                            ...
                            <span className="text-[13px] font-[500] text-white tracking-widest leading-none mt-0.5">Pay</span>
                          </div>
                        </div>
                      )}
