export const translations = {
  pt: {
    ...
    hero: {
      ...
      title1: "Aprenda importar da China com seguro de envio incluso e sem burocracias alfandegárias.",
      title2: "",
      title3: "",
    ...
    planos: {
      ...
      starter: {
        ...
        period: "Trimestral",
        subDesc: "Receba 3 meses de acesso.",
        price: "97,00",
        originalPrice: "97,00",
        monthlyPrice: "97,00",
        periodLabel: "/trimestre",
        info: "PAGAMENTO ÚNICO DE R$ 97,00",
        items: [
      ...
      pro: {
        ...
        period: "Anual",
        subDesc: "Receba 1 ano de acesso.",
        price: "197,00",
        originalPrice: "197,00",
        monthlyPrice: "197,00",
        periodLabel: "/ano",
        info: "PAGAMENTO ÚNICO DE R$ 197,00",
        items: [
      ...
      elite: {
        ...
        period: "Vitalício",
        subDesc: "Receba acesso para sempre.",
        price: "389,00",
        originalPrice: "389,00",
        monthlyPrice: "389,00",
        periodLabel: "/vitalício",
        info: "PAGAMENTO ÚNICO DE R$ 389,00",
        items: [
  ...
  'pt-PT': {
    ...
    planos: {
      ...
      starter: {
        ...
        monthlyPrice: "16.00",
        period: "/único",
        info: "PAGAMENTO ÚNICO DE 16,00 EUR",
        items: [
          { text: "Acesso às fábricas diretas na China.", status: true },
      ...
      pro: {
        ...
        monthlyPrice: "32.00",
        period: "/único",
        info: "PAGAMENTO ÚNICO DE 32,00 EUR",
        items: [
          { text: "Acesso a fábricas exclusivas na China.", status: true },
      ...
      elite: {
        ...
        monthlyPrice: "64.00",
        period: "/único",
        info: "PAGAMENTO ÚNICO DE 64,00 EUR",
        items: [
          { text: "Acesso a Apple oficial na China, produtos originais, lacrados, desbloqueados e com 1 ano de garantia global", status: true },
          { text: "Baixar imagens ilimitadas", status: true },
          { text: "Painel de fábricas e produtos exclusivos não divulgados publicamente.", status: true },
  ...
  en: {
    ...
    hero: {
      ...
      title1: "Learn to import from China with shipping insurance included and without customs bureaucracy.",
      title2: "",
      title3: "",
      titleMob: "Learn to import from China with shipping insurance included and without customs bureaucracy.",
      desc: "More than 25,000 members have already proven, importing from China can be as simple as buying on a marketplace, for resale or personal use, with no minimum quantity. At Connect Academy you have classes, real-time tracking, Minerador (the AI that eliminates customs bureaucracies), shipping insurance included and much more. All in an ecosystem made for those who want to import smartly.",
  ...
  es: {
    ...
    hero: {
      ...
      title1: "Aprende a importar de China con seguro de envío incluido y sin burocracias aduaneras.",
      title2: "",
      title3: "",
      titleMob: "Aprende a importar de China con seguro de envío incluido y sin burocracias aduaneras.",
      desc: "Más de 25.000 miembros ya han probado, importar de China puede ser tan simple como comprar en un marketplace, para reventa o uso personal, sin cantidad mínima. En Connect Academy tienes clases, rastreo en tiempo real, Minerador (la IA que elimina burocracias aduaneras), seguro de envío incluido y mucho más. Todo en un ecosistema hecho para quienes quieren importar con inteligencia.",
  ...
  fr: {
    ...
    hero: {
      ...
      title1: "Apprenez à importer de Chine avec assurance expédition incluse et sans bureaucratie douanière.",
      title2: "",
      title3: "",
      titleMob: "Apprenez à importer de Chine avec assurance expédition incluse et sans bureaucratie douanière.",
      desc: "Plus de 25 000 membres l'ont déjà prouvé, importer de Chine peut être aussi simple qu'acheter sur une place de marché, pour la revente ou un usage personnel, sans quantité minimum. Chez Connect Academy, vous avez des cours, un suivi en temps réel, le Minerador (l'IA qui élimine la bureaucratie douanière), une assurance expédition incluse et bien plus encore. Le tout dans un écosystème conçu pour ceux qui veulent importer intelligemment.",
