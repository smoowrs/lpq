      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);max-width:600px;width:100%;">
        ...
        <tr>
          <td style="padding:40px 44px 0;">
            <p style="font-size:16px;color:#111827;margin:0 0 16px;font-weight:600;">Ola, ${name}! 👋</p>
          ...
          <td style="padding:0 44px 44px;">
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr><td align="center" style="padding:8px 0 22px;">
                <a href="${appUrl}" style="display:inline-block;background:linear-gradient(135deg,#4C35E8 0%,#7B5CE7 100%);color:#ffffff;text-decoration:none;font-size:16px;font-weight:700;padding:17px 46px;border-radius:14px;letter-spacing:0.01em;box-shadow:0 6px 24px rgba(76,53,232,0.30);">
                  Entrar no App agora →
                </a>
              </td></tr>
            </table>
            <p style="font-size:12px;color:#9CA3AF;text-align:center;margin:0 0 28px;line-height:1.6;">
