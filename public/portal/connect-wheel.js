...
`; const style = document.createElement('style'); style.textContent = css; root.append(style);
    ...
    function spin() {
      ...
      const emailInput = $('#cw-lead-email');
      if (emailInput) {
          ...
          try {
              fetch('https://bfyfzpjivesrbcxilmzd.supabase.co/rest/v1/landing_leads', {
                  method: 'POST',
                  headers: {
                      'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJmeWZ6cGppdmVzcmJjeGlsbXpkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzA2NTE1ODUsImV4cCI6MjA4NjIyNzU4NX0.4q3uB1PrFPbaH4lunmQ6wZU0jNABg2D0i45JRHXo_K0',
                      'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJmeWZ6cGppdmVzcmJjeGlsbXpkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzA2NTE1ODUsImV4cCI6MjA4NjIyNzU4NX0.4q3uB1PrFPbaH4lunmQ6wZU0jNABg2D0i45JRHXo_K0',
                      'Content-Type': 'application/json',
                      'Prefer': 'return=minimal'
                  },
                  body: JSON.stringify({ email: email, source: 'vsl_roleta', page_url: window.location.href, ab_group: window._caRegion || 'BR' })
              }).catch(()=>{});
          } catch(e) {}
      }
